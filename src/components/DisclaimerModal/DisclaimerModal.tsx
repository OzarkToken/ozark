    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the ozark protocol have made
      ...
      return (
        <div>
          <p>Attention OZARK Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with OZARK is OZ/yCRV
            (Curve yPool OZARK)
          </p>
